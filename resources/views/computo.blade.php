    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            Categorias de computo
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/escritorio">Escritorio</a></li>
                            <li><a class="dropdown-item" href="/portatil">Portatil</a></li>
                            <li><a class="dropdown-item" href="/servidor">Servidor</a></li>
                            <li><a class="dropdown-item" href="/tablets">Tablets</a></li>
                        </ul>
                    </li>
                </ul>
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Computo</li>
        </ol>
      </nav>
</header>
<body>
